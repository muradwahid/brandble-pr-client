...
const OrderStatus = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-fill-available font-poppins border-y border-[#DCDEDF] py-8 mt-8">
        <div className="flex">
          {/* total orders */}
          <div className="border-r border-[#DCDEDF] pr-6 flex-[0.8]">
          ...
          {/* order status */}
          <div className="border-r border-[#DCDEDF] px-6 flex-[0.7]">
          ...
          {/* publication */}
          <div className="flex flex-[1.5] justify-between gap-6">
            ...
            <div className="home-publication-rechart-wrapper">
              <HChart />
              <p className="text-[#5F6368] text-sm text-end underline cursor-pointer">view all</p>
            </div>
          </div>
        </div>
      </div>
